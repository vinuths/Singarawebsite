...
const Footer = () => {
  return (
    ...
    <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
      <div className="cursor-pointer inline-flex flex-col items-center leading-tight">
        <Link to="home" smooth={true} duration={500} className="text-blue-800 text-center">
          <span className="block text-5xl font-extrabold">SINGARA</span>
          <span className="block text-2xl">Estates And Properties</span>
        </Link>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
          <div className="col-span-1">
            ...
            <p className="text-white mb-4">SINGARA Estates And Properties is a leading provider of real estate services, with a focus on delivering exceptional value to our clients. Our team of experts has deep industry knowledge and a proven track record of success.</p>
        ...
        <div className="mt-8 flex justify-center">
          <p className="text-base text-white">&copy; {new Date().getFullYear()} SINGARA Estates And Properties. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
